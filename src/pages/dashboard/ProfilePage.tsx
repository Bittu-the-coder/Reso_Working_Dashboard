...
const ProfilePage = () => {
    ...
    return (
        <div className={`flex min-h-screen ${darkModeClasses.container}`}>
            {/* Sidebar */}
            <div
                className={`w-64 ${darkModeClasses.sidebar} shadow-lg p-6 border-r`}
            >
            ...
            <div className="flex-1 p-8">
                {activeTab === "profile" && (
                    <div
                        className={`${darkModeClasses.card} rounded-lg shadow-sm p-6`}
                    >
                ...
                {activeTab === "notifications" && (
                    ...
                    >
                        ...
                        {notifications.length > 0 ? (
                            ...
                            <p
                                className={`${darkModeClasses.text.muted} text-center py-8`}
                            >
